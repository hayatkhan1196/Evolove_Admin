...
const MoonCalenderBlogDeatils = () => {
  const params = useParams();
  const { id } = params;
  console.log("🚀 ~ file: MoonCalenderBlogDeatils.js ~ line 23 ~ MoonCalenderBlogDeatils ~ id", id)
...
export default MoonCalenderBlogDeatils